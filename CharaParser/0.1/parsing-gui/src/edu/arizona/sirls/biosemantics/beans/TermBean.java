package edu.arizona.sirls.biosemantics.beans;
...
public class TermBean {
	...
	public TermBean(Group termGroup, Group deletedGroup, boolean toggleGroup, String text) {
		...
		delete.setImage(SWTResourceManager.getImage(TermBean.class, "/edu/arizona/sirls/biosemantics/parsing/remove.jpg"));
