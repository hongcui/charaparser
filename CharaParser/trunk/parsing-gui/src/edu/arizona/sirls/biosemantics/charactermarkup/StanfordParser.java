 /* $Id: StanfordParser.java 1490 2013-04-16 21:57:03Z hong1.cui@gmail.com $ */
/**
 * 
 */
...
import edu.arizona.sirls.biosemantics.parsing.Learn2Parse;
...
public class StanfordParser implements Learn2Parse, SyntacticParser{
	...
	private static StructureNameNormalizer snn;
	...
	public StanfordParser(String posedfile, String parsedfile, String database, String tableprefix, String glosstable, boolean evaluation) {
		...
		if(Boolean.valueOf(ApplicationUtilities.getProperty("attachparentorgan")))
			snn = new StructureNameNormalizer(conn, this.tableprefix);
	}
	...
	private void placeDescription(Element description, String dID, Element baseroot) {
		...
		if(snn!=null) description = snn.normalize(description);
	...
	public static void main(String[] args) {
		...
		*/
		...
		StanfordParser sp = new StanfordParser(posedfile, parsedfile, database, prefix, "nematodesglossaryfixed", false);
