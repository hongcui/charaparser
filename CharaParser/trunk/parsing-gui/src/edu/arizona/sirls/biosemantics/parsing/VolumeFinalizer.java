/**
 * $Id: VolumeFinalizer.java 1518 2013-04-24 18:04:34Z hong1.cui@gmail.com $
 */
...
public class VolumeFinalizer extends Thread {
    ...
    private static String version="$Id: VolumeFinalizer.java 1518 2013-04-24 18:04:34Z hong1.cui@gmail.com $";
	...
	private static String standalonefolder =  ApplicationUtilities.getProperty("target").replaceFirst("//target", "");
